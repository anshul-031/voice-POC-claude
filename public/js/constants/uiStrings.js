...
export const UI_STRINGS = {
  ...
  signaling: {
    ...
    logs: {
      ...
      playbackContextCreated: (/** @type {number} */ sampleRate) => `Playback audio context created (${sampleRate}Hz)`,
      silentAudioUnlockPlayed: 'Silent audio element played for iOS unlock',
      silentAudioUnlockFailed: (/** @type {string} */ msg) => `Silent audio element unlock failed: ${msg}`,
      scriptProcessorIsolated: 'ScriptProcessor connected to silent gain (iOS isolation)',
