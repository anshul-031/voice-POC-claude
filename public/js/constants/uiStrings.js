...
export const UI_STRINGS = {
  ...
  toasts: {
    ...
    campaignQueued: (/** @type {number} */ n) =>
      `${n} number(s) queued — they are dialled as calls finish, to stay inside the provider's concurrency limit`,
    campaignRetriedFailed: (/** @type {number} */ n) => `Retrying ${n} failed number(s)`,
  ...
  telephony: {
    ...
    card: {
      ...
      edit: 'Edit',
      delete: 'Delete',
      concurrency: (/** @type {number} */ n) => `${n} concurrent call${n === 1 ? '' : 's'}`,
    },
  },
  campaigns: {
    title: 'Campaigns',
    ...
    contactStatus: {
      ...
      total: 'Total',
      noDetail: '—',
      autoRefresh: 'Live — refreshing automatically',
      progress: (/** @type {number} */ done, /** @type {number} */ total) =>
        `${done} of ${total} processed`,
      showing: (/** @type {number} */ shown, /** @type {number} */ total) =>
        `Showing all ${shown} of ${total} numbers`,
    },
    ...
    confirmRetryFailed: 'Retry only the failed numbers in this campaign?',
  },
  callHistory: {
    title: 'Call History',
